...
Author: Diogo Almeida (founder, TypeSafe AI). Published 2026-09-15 (page metadata).
Retrieved 2026-09-23. Body text extracted from the page HTML with trafilatura; charts,
videos and embedded figures are not captured. The FAQ answers are collapsed accordions
that the extractor dropped; their text was recovered verbatim from the page's embedded
content JSON (links inside them are lost, link text kept).
-->
