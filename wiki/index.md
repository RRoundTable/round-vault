...
| --------------------- | --------------------------------------------------------------------------------------------------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| `agent-architectures` | Decomposition of agent systems: planning, delegation, multi-agent structure, control loops.                     | [[harness]]                   | A real multi-agent postmortem; something on when delegation stops paying; the primary papers behind [[self-improving-harness]]. |
